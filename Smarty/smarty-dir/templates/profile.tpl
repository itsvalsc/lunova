                        ...
                        <div class="card overflow-hidden">
                            ...
                            <div class="card-body pt-0">
                                ...
                                <ul class="nav nav-link-secondary flex-column fw-bold gap-2">
                                    ...
                                    <li class="nav-item">
                                        <a class="nav-link" href="events.html"> <i class="fa-solid fa-album-circle-plus"></i> <img class="me-2 h-20px fa-fw" src="assets/images/icon/calendar-outline-filled.svg" alt=""><span>Aggiungi disco</span></a>
                                        <hr>
                                    </li>
                                    <li class="nav-item">
